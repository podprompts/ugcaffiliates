      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{ background: '#f9f8f6', border: '1px solid #e8e6e2', borderRadius: '4px', padding: '1.25rem 1.5rem', marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
            {['Vendors', 'Affiliates', 'Payments', 'Tracking', 'Assets', 'Installation', 'Fees', 'Legal'].map(label => (
              <span key={label} style={{ fontSize: '12px', background: '#ffffff', border: '1px solid #e8e6e2', borderRadius: '3px', padding: '0.25rem 0.6rem', color: '#3a3a3a' }}>{label}</span>
            ))}
          </div>
        </div>
