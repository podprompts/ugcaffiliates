    ...
    <div style={{ minHeight: '100vh', background: '#f9f8f6', display: 'flex', flexDirection: 'column' as const }}>
      ...
      <nav style={{ background: '#ffffff', borderBottom: '1px solid #e8e6e2', padding: '0 2.5rem', display: 'flex', alignItems: 'center', height: '64px' }}>
        ...
        <div style={{ marginLeft: 'auto', fontSize: '13px', color: '#888' }}>
          New to UGCA?{' '}
          <Link href="/signup" style={{ color: '#0d0d0d', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: '2px' }}>Create account</Link>
        </div>
      </nav>
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column' as const, gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ marginTop: '0.4rem', textAlign: 'right' as const }}>
                <Link href="/forgot-password" style={{ fontSize: '12px', color: '#888', textDecoration: 'underline' }}>Forgot password?</Link>
              </div>
            </div>
